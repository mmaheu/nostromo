...
def helmInstall (namespace, release) {
    ...
    echo "We made it past the Helm install section"
}
...
pipeline {
    ...
    parameters {
        ...
        string (name: 'DOCKER_USR',       defaultValue: 'mmaheu',                                  description: 'Your Docker repository user')
        string (name: 'DOCKER_PSW',       defaultValue: 'go2group!',                           description: 'Your Docker repository password')
        ...
        string (name: 'HELM_REPO',        defaultValue: 'http://nexus.go2group.tech/charts',            description: 'Your helm repository')
        string (name: 'HELM_USR',         defaultValue: 'admin',                                   description: 'Your helm repository user')
        string (name: 'HELM_PSW',         defaultValue: 'Cubalibre!',                                description: 'Your helm repository password')
    }
