...
pipeline {
    ...
    parameters {
        ...
        string (name: 'DOCKER_PSW',       defaultValue: 'YourPassword',                                            description: 'Your Docker repository password')
        ...
        string (name: 'HELM_PSW',         defaultValue: 'secrets',                                               description: 'Your helm repository password')
    }
